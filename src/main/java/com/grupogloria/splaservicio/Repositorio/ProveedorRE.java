...
public class ProveedorRE implements ProveedorIN
{
    ...
    public ObjetoProveedorMO CrearProveedor(ProveedorMO clienteMO) throws Exception
    {
        ...
        try
        {
            ...
            _cst = _con.prepareCall("{call " + Constante.SP_CREAR_PROVEEDOR + "(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)}");
            ...
            if (_rst.isBeforeFirst())
            {
                if (_rst.next())
                {
                    objetoProveedorMO.setCodigo(_rst.getInt(Constante.CODIGO));
                    objetoProveedorMO.setMensaje(_rst.getString(Constante.MENSAJE));
                }
            }
        }
        catch (Exception e)
    ...
    public ObjetoProveedorMO ActivarProveedor(String idInternoCliente) throws Exception
    {
        ...
        {
            _con = _conexion.ObtenerConexion();
            _cst = _con.prepareCall("{call " + Constante.SP_ACTIVAR_PROVEEDOR + "(?, ?)}");
    ...
    public ObjetoProveedorMO EditarProveedor(ProveedorMO clienteMO) throws Exception
    {
        ...
        {
            _con = _conexion.ObtenerConexion();
            _cst = _con.prepareCall("{call " + Constante.SP_EDITAR_PROVEEDOR + "(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)}");
            _cst.setString(Constante._1, clienteMO.getIdInternoCliente());
            _cst.setString(Constante._2, clienteMO.getDenominacion());
            _cst.setString(Constante._3, clienteMO.getDocumento());
    ...
    public ObjetoProveedorMO InactivarProveedor(String idInternoCliente) throws Exception
    {
        ...
        {
            _con = _conexion.ObtenerConexion();
            _cst = _con.prepareCall("{call " + Constante.SP_INACTIVAR_PROVEEDOR + "(?, ?)}");
            _cst.setString(Constante._1, idInternoCliente);
            _cst.setString(Constante._2, Constante.USUARIO_EDICION);
            _cst.executeQuery();
            _rst = _cst.getResultSet();
